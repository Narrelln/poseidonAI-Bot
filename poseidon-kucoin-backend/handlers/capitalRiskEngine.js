...
let capitalState = {
  ...
  function recordTrade(amount, isProfitRecycled = false) {
  ...
  function applyTradeOutcome(pnlAmount = 0) {
  ...
  function resetCapitalTracker(startingBalance = 100) {
    capitalState = {
